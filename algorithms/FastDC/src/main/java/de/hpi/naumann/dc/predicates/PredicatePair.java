...
public class PredicatePair implements PartitionRefiner {
	...
	public boolean bothContainedIn(IPredicateSet set) {
		return set.containsPredicate(p1) && set.containsPredicate(p2);
	}
	...
	public boolean bothContainedIn(Set<Predicate> pairSet) {
		return pairSet.contains(p1) && pairSet.contains(p2);
	}
